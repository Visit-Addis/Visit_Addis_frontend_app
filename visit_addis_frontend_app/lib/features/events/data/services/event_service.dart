  ...
  List<Event> _getMockEvents() {
    return [
      Event(
        ...
        description: 'Experience the best of Ethiopian Jazz with live performances from local artists.',
      ...
      Event(
        ...
        description: 'Learn about and experience the traditional Ethiopian coffee ceremony.',
        venue: 'Tomoca Coffee',
      ...
      Event(
        ...
        description: 'Contemporary Ethiopian artists showcase their latest works.',
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (category != null && category != 'All') {
          mockEvents = mockEvents.where((event) => event.category == category).toList();
        }
        if (searchQuery != null && searchQuery.isNotEmpty) {
          mockEvents = mockEvents.where((event) => 
